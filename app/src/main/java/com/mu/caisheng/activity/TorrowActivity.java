...
public class TorrowActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void getTorrowAdv() {
        ...
        utils.send(HttpRequest.HttpMethod.POST, Constant.ROOT_PATH + "tomorrowForecast", rp, new RequestCallBack<String>() {
            @Override
            public void onStart() {
                ...
                try {
                    ...
                    if (Constant.RETURN_OK.equals(state.msg)) {
                        ...
                        ToastUtils.displayShortToast(
                                TorrowActivity.this, state.result);
                        ToosUtils.goLogin(TorrowActivity.this);
                    } else {
                        ToastUtils.displayShortToast(
                                TorrowActivity.this, state.result);
                    }
                    ...
                    e.printStackTrace();
                    ToastUtils.displaySendFailureToast(TorrowActivity.this);
                }
            }
