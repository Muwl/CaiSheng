...
public class IdentifyNumPage extends FakeActivity implements OnClickListener,
    ...
    public void onCreate() {
        ...
        if (layout != null) {
            ...
            btnSounds = findViewById(Res.id.btn_sounds);
        ...
        if (type == 1) {
            ...
            if (resId > 0) {
                ...
                if (layout != null) {
                    ...
                    dialog.findViewById(Res.id.btn_dialog_ok).setOnClickListener(new OnClickListener() {
                        public void onClick(View v) {
                            // TODO 发送语言
                            dialog.dismiss();
                    ...
                    dialog.findViewById(Res.id.btn_dialog_cancel).setOnClickListener(new OnClickListener() {
                        public void onClick(View v) {
                            dialog.dismiss();
                        }
                    });
